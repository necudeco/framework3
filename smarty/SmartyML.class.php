<?php
  ...
  function smarty_prefilter_i18n($tpl_source, &$smarty) {
    ...
    $GLOBALS['_NG_LANGUAGE_']->loadTranslationTable($GLOBALS['_NG_LANGUAGE_']->_currentLocale, "../languages/". $GLOBALS['_NG_LANGUAGE_']->_currentLocale."/common.lng");
  ...
  class smartyML extends Smarty {
    ...
    function fetch($_smarty_tpl_file, $_smarty_cache_id = null, $_smarty_compile_id = null, $_smarty_parent = null, $_smarty_display = false) {
      ...
      $fetch = parent::fetch( $_smarty_tpl_file, $_smarty_cache_id, $_smarty_compile_id, $_smarty_parent, $_smarty_display );
  ...
  class ngLanguage {
    ...
    function _loadTranslationTable($locale, $path='') { 
      ...
      if(empty($path))
//        $path = '../languages/'.$this->_languageTable[$locale].'/'.NOM_PAGE.'.lng';
      ...
      //echo('bonjour'.$path.$locale.file_exists($path));
      //ajout julien
      //$this->_loadTranslationTable('en', "languages/".$language."/common.lng");
    ...
    function loadTranslationTable($locale, $path) {
      ...
      /*
      if(empty($path))
        $path = "languages/".$language."/".NOM_PAGE.".lng";
     */


      //$this->loadTranslationTable('en', "languages/".$language."/common.lng");
